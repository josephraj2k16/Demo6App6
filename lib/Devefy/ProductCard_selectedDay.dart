import 'package:MediAssist/Devefy/stepIndicator_selectedDay.dart';
import 'package:flutter/material.dart';
import 'CustomIcon.dart';
import 'package:MediAssist/stepindicator.dart';

class ProductCard_selectedDay extends StatelessWidget {
  int cardColor;
  String imgUrl;
  String title;
  String description;
  ...
  ProductCard_selectedDay(this.cardColor, this.imgUrl, this.title, this.description,
      this.refills,this.selectedDay,this.drugid, this.schedule,this.intake);



  List<dynamic> _stepsText =[];// ["8.00-10.00AM", "1.00-2.00PM", "8.00-9.00PM"];

  //schedule.forEach((f)=>_stepsText=f.toString());
  ...
  StepProgressView_selectedDay _getStepProgress() {
    return StepProgressView_selectedDay(
      title,
      selectedDay,
      //schedule,
      drugid,
