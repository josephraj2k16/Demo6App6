...
class FoodInteraction extends StatefulWidget {
  FoodInteraction({Key key, this.auth, this.userId, this.onSignedOut})
      : super(key: key);
  ...
  @override
  _FoodInteractionState createState() => new _FoodInteractionState();
}

class _FoodInteractionState extends State<FoodInteraction> {
  String _userId = "";
